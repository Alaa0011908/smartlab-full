...
export default function Signup() {
  ...
  return (
    <>
      <Head>
        <title>إنشاء حساب - Smart Lab</title>
        <meta name="description" content="أنشئ حسابك في منصة سمارت لاب التعليمية." />
        ...
        <style>{`
          ...
          * { box-sizing: border-box; }
          ...
          @media (max-width: 640px) {
            .signup-card { padding: 36px 24px 40px !important; }
          }
        `}</style>
      </Head>
        ...
        <div style={{ ...styles.card, padding: isMobile ? "36px 24px 40px" : styles.card.padding }} className="signup-card">
          ...
          {!showOtp ? (
            <form onSubmit={handleSendOTP}>
              ...
              >
                {loading ? "جاري الإرسال..." : <><CreateArrowIcon /> إنشاء حساب</>}
              </button>
            </form>
          ) : (
            <form onSubmit={handleVerifyOTP}>
              ...
              <button type="button" onClick={goBackToEmail} style={styles.backToEmail}>
